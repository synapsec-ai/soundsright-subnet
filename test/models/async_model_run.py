...
class AsyncModelRunTester:
    ...
    def __init__(self):
        ...
        self.model_path_6 = os.path.join(self.base_path,'models','model6')
        self.model_path_7 = os.path.join(self.base_path,'models','model7')
        self.model_path_8 = os.path.join(self.base_path,'models','model8')
        self.model_path_9 = os.path.join(self.base_path,'models','model9')
        self.model_path_10 = os.path.join(self.base_path,'models','model10')
