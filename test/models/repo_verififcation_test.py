...
@pytest.mark.parametrize("namespace, name, revision, outcome",[
    ...
    ("synapsecai", "SoundsRightModelTemplate", "191137582e8f5b67a0d5fee2f60a08a8a46f3d98", False),
    ("synapsecai", "SoundsRightModelTemplate", "70a8146e69bc18074f6b73f9ea4bf068aaa3ec8b", False),
])
